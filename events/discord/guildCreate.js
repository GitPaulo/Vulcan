...
module.exports = async guild => {
  ...
  if (!responseChannel) {
    responseChannel = await guild.channels.create(vulcan.constants.guild.botChannel, {
      type: 'text',
  ...
  if (!guild.authorised) {
    ...
    (title = `Hello World!`),
      (description =
        `Thank you for inviting Vulcan to your guild.\n\n` +
    ...
    (title = `Hello again?`),
      (description =
        `This guild is already registered as **authorised**!\n` +
